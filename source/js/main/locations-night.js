...
(async function () {
  ...
  const locations = [
    ...
    },
    {
      ...
      content: ["Воркаут", "Паркур", "Степ-аэробика", "Гидрофлай"],
    },
    {
      name: "Климентовский переулок",
      value: "klimentovsky",
      coords: [55.741039, 37.626292].reverse(),
      content: ["Сайклинг", "Функциональные петли", "Тренировка в гамаках"],
    },
    {
    ...
    },
    {
      ...
      content: ["Живые шахматы", "Фан-встречи", "Автограф-сессии"],
    },
    {
