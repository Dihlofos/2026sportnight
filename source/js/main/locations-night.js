...
(async function () {
  ...
  const locations = [
    ...
    },
    {
      ...
      content: ["Фан-встречи", "Степ-аэробика", "Воркаут", "Паркур", "Гидрофлай"],
    },
    {
      name: "Климентовский переулок",
      value: "klimentovsky",
      coords: [55.741039, 37.626292].reverse(),
      content: ["Тренировка в гамаках", "Функциональные петли", "Сайклинг"],
    },
    {
      name: "Кудринская площадь",
      value: "kudrinskaya",
      coords: [55.758589, 37.583863].reverse(),
      content: ["Джампинг", "Полоса препятствий", "Прыжки в длину"],
    },
    // {
    //   name: "Ильинский сквер",
    //   value: "ilinsky",
    //   coords: [55.754603, 37.634044].reverse(),
    //   content: ["Живые шахматы"],
    // },
    {
    ...
    },
    {
      ...
      content: [
        'группа "Белое Злато" и Вадим Звягинцев'
      ],
      outerLink: "https://letochess.sport.mos.ru/",
      noLink: true,
    },
    {
      ...
      content: [
        'Ева Власова и Александр Морозевич'
      ],
      outerLink: "https://letochess.sport.mos.ru/",
      noLink: true,
    },
